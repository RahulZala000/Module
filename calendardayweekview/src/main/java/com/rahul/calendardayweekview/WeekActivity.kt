...
import com.rahul.calendardayweekview.databinding.ActivityDayBinding
import java.time.DayOfWeek
import java.time.LocalDateTime
import java.util.*
import kotlin.collections.ArrayList

class WeekActivity @JvmOverloads constructor(context: Context, attributeSet: AttributeSet) :
    ...
    init {
        ...
        binding = ActivityDayBinding.inflate(LayoutInflater.from(context), this)
      //  temp= selectdate
        setWeekView()
